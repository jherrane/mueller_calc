...
double precision :: intN(Np)

double precision :: Kl(Np+1), rmp1(3), slv(3), sl(3), ml(3), pl1mr(3), pl2mpl1(3), rmplm1(3), pl1mpl0(3), tl(3), Il(3)
double precision :: w0, normslv, tl0, ll, sml, spl, Rpl, Rml, R0l, Bl, Km3
...
double precision, intent(in) :: rf(3), k
double precision, dimension(:) :: wb_tet
double precision, dimension(:,:) :: Pb_tet, B_coord

double complex :: intN

double precision, parameter :: fact(6)=[1.0, -0.5, 1.0/24, -1.0/720, 1.0/40320, -1.0/3628800]  
double precision, parameter :: ak(5)=[1.0/2, 1.0/4, 1.0/6, 1.0/8, 1.0/10] 

double complex :: intR, II, G0
double precision :: intR2(Np), intR4(Np)


integer :: i1, l, f1, l2, j1
double precision :: rp(3), RR, tet_n(3,4), tri_coord(3,3), tri_n(3), rr2(3), cut

double precision :: f, a1, f2
...
double precision, intent(in) :: rf(3), tri_n(3), k
double precision, intent(in) :: tri_coord(3,3)
double precision, dimension(:,:), intent(in) :: Pb_tri
double precision, dimension(:), intent(in) :: wb_tri

double precision, parameter :: fact(6)=[1.0, -0.5, 1.0/24, -1.0/720, 1.0/40320, -1.0/3628800]  

double precision :: rp(3), R, f, intR2(Np), f2, cut
double complex :: intN, intR, II, G0
integer :: i1, l, l2
...
double complex :: intR(3), II(3), G0(3)
double precision :: intR2(Np), intR4(3,Np)


integer :: i1, l, f1, l2, j1
double precision :: rp(3), RR, tet_n(3,4), tri_coord(3,3), tri_n(3), rr2(3), cut

double precision :: f, a1, f2(3)
