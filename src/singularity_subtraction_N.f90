...
double precision, dimension(:,:) :: Pb_tet, B_coord, shape_tet

double complex :: intN(4)
integer, parameter :: Np = 1
...
double precision, parameter :: ak2(5)=[1.0/1, 1.0/3, 1.0/5, 1.0/7, 1.0/9] 

double complex :: intR(4), II, G0
double precision :: intR2(3,Np+1), intR4(Np), intR6(4,Np), n_dN(4), intR5(4,Np)


integer :: i1, l, f1, l2, j1, N_ind(3), j2
double precision :: rp(3), RR, tet_n(3,4), tri_coord(3,3), tri_n(3), rr2(3), cut

double precision :: f, a1, f2(4), rot(3,6), dN(3,4)
...
double precision :: rp(3), R, f, intR2(3,Np), f2(3), cut
double complex :: intN(3), intR(3), II, G0
integer :: i1, l, l2
