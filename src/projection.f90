...
do tet_B = 1,mesh%N_tet
   ...
   do m1 = 1,Ns
      ...
      !Q(m1) = singular_subtraction_int_V_G(P_sph(:,m1)+cp_cube, mesh%k, Pb, wb, B_coord)
      ...
      do face =1,4
         ...
         !Q2 = singular_subtraction_int_S_G(P_sph(:,m1)+cp_cube, tri_coord, nvec, mesh%k, P_tri, W_tri)
...
double precision, dimension(:), allocatable :: wb, W_tri, w0_tet, w0_tri
double precision ::  cp(3), vol_B, tri_coord(3,3), nvec(3), P_node(3),  B_coord(3,4), node1(3), cp_cube(3)
double complex, dimension(:), allocatable :: sigma, sigma2x, sigma2y, sigma2z, QdN
double complex, dimension(:,:), allocatable :: Q, Q2x, Q2y, Q2z
double complex, dimension(:,:), allocatable :: W, WW
double precision, dimension(:,:), allocatable :: shape_tet, shape_tri
double complex :: Q2(3)
integer :: B_nodes(4), Ns, n1, T_nodes(3)
integer :: ind(12)=[2,3,4,1,4,3,1,2,4,1,3,2]
double precision :: B_rot(3,6), B_dN(3,4)
