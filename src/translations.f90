...
real(dp) :: tr(3), dir(3)
complex(dp), dimension((N_in+1)**2-1,2) :: a_in, b_in
complex(dp), dimension((N_out+1)**2-1,2) :: a_out, b_out
...
complex(dp) :: k
integer :: N_in, N_out, inout, m, n, nu, las, nm_out, nm_in, las2
